...
class Ecclesia::Greeter::Stores::Schema::Result::Checkin extends DBIx::Class::Core, DBIx::Class::InflateColumn::DateTime {
    use DBIx::Class::Candy -autotable => v1;
    use DBIx::Class::Relationship::Abbreviate qw/ result /;

    primary_column id => { data_type => 'int', is_auto_increment => 1, };

    column date => { data_type => 'date',  inflate_datetime => 1, };
